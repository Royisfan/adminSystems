...
<body>
	...
	<div class="right">
        ...
        ?>
        <div>
            留言人：<?php echo $value['username']?><br/>
            时间：<?php echo $value['time']?><br/>
            内容：<?php echo $value['context']?><br/>
        </div><hr/>
       <?php
            }
                }
       ...
       <div class="right_bottom">
            <form id="login" name="message" method="post" action="messageCheck.php">
            <input type="text" class="right_bottom_1" name="text"/><br/>   
            <input type="submit" class="right_bottom_2" name="submit" value="提交"  onclick="winclose()"/>  
            </form>
       </div>
	</div>
</body>
