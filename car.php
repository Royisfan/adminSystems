...
<body>
	...
	<div class="right">
		<div class="middle">
		    <h2 style="text-align:center;">机动车指标申请</h2><hr/><br/>
		    <form id="login" name="login" method="post" action="carCheck.php">
	            <input type="text" name="username" id="username" value="请输入姓名"/><br/>  
                <input type="text" name="carNumber" value="请输入驾驶证号"/><br/>
                <input type="text" name="telNum" value="请输入电话号码"/><br/> 
                <input type="text" name="email" value="请输入电子邮箱"/><br/>  
